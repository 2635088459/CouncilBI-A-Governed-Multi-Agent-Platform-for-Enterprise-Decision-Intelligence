...
('usr_acme_admin',
 ...
 'org_acme', ARRAY['admin'], ARRAY['read_p0','read_p1','manage_users'], 1,
...
('usr_acme_analyst',
 ...
 'org_acme', ARRAY['analyst'], ARRAY['read_p2'], 1,
...
('usr_tech_admin',
 ...
 'pbkdf2_sha256$210000$Y2hhdGJpX2RlbW9fc2FsdA==$sxJIICrxb1hajA2aDT9vSnlgi9JyIgaBztBOsuyl2OM=',
 'org_techstart', ARRAY['admin'], ARRAY['read_p0','read_p1','manage_users'], 1,
 '2025-03-01T09:00:00Z', '2025-03-01T09:00:00Z'),

('usr_tech_analyst',
 'evan.park@techstart.com','Evan Park',
 'pbkdf2_sha256$210000$Y2hhdGJpX2RlbW9fc2FsdA==$Bjnxm7-Ow1HCEVeEnBuQAt_Y6LB0CmeUYGcOQxF4moQ=',
 'org_techstart', ARRAY['analyst'], ARRAY['read_p2'], 1,
...
('usr_retail_admin',
 ...
 'pbkdf2_sha256$210000$Y2hhdGJpX2RlbW9fc2FsdA==$sxJIICrxb1hajA2aDT9vSnlgi9JyIgaBztBOsuyl2OM=',
 'org_globalretail', ARRAY['admin'], ARRAY['read_p0','read_p1','manage_users'], 1,
 '2025-06-01T10:00:00Z', '2025-06-01T10:00:00Z'),

('usr_retail_analyst',
 'helen.zhang@globalretail.com','Helen Zhang',
 'pbkdf2_sha256$210000$Y2hhdGJpX2RlbW9fc2FsdA==$Bjnxm7-Ow1HCEVeEnBuQAt_Y6LB0CmeUYGcOQxF4moQ=',
 'org_globalretail', ARRAY['analyst'], ARRAY['read_p2'], 1,
